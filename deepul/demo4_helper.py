...
def demo3_save_results(part, fn):
    ...
    plot_gan_training(
        losses,
        "Demo 3{} Losses".format(part),
        "results/demo3{}_losses.png".format(part),
    )
    ...
    q1_gan_plot(
        ...
        xs1,
        ys1,
        "Demo 3{} Epoch 1".format(part),
        "results/demo3{}_epoch1.png".format(part),
    )
    q1_gan_plot(
        data,
        samples_end,
        xs_end,
        ys_end,
        "Demo 3{} Final".format(part),
        "results/demo3{}_final.png".format(part),
    )
...
def demo4_save_results(fn):
    ...
    show_samples(
        samples[:100] * 255.0,
        fname="results/demo4_samples.png",
...
def demo7_save_results(fn):
    ...
    gan_losses, samples, reconstructions, pretrained_losses, random_losses = fn(
    ...
    plot_q3_supervised(
        pretrained_losses,
        random_losses,
        "Linear classification losses",
        "results/demo7_supervised_losses.png",
    )
    show_samples(
        samples * 255.0,
        fname="results/demo7_samples.png",
        title="BiGAN generated samples",
    )
    show_samples(
        reconstructions * 255.0,
        nrow=20,
        fname="results/demo7_reconstructions.png",
